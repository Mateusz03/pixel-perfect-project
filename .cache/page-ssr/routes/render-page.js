...
var React = _interopRequireWildcard(__webpack_require__(4377));
...
var _react = __webpack_require__(4377);
...
var _react = _interopRequireDefault(__webpack_require__(4377));
...
exports.components={"component---src-pages-index-js":()=>__webpack_require__.e(/* import() | component---src-pages-index-js */ 678).then(__webpack_require__.bind(__webpack_require__, 8749))};
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4377);
...
const internalProps={...props,sliceName:props.alias};delete internalProps.alias;delete internalProps.__renderedByLocation;const slicesContext=(0,external_C_Users_mateu_OneDrive_Pulpit_pixel_perfect_project_node_modules_react_index_js_.useContext)(context.SlicesContext);// validate props
const propErrors=validateSliceProps(props);if(Object.keys(propErrors).length){throw new SlicePropsError(slicesContext.renderEnvironment===`browser`,internalProps.sliceName,propErrors,props.__renderedByLocation);}if(slicesContext.renderEnvironment===`server`){return/*#__PURE__*/external_C_Users_mateu_OneDrive_Pulpit_pixel_perfect_project_node_modules_react_index_js_default().createElement(ServerSlice,internalProps);}else if(slicesContext.renderEnvironment===`browser`){// in the browser, we'll just render the component as is
return/*#__PURE__*/external_C_Users_mateu_OneDrive_Pulpit_pixel_perfect_project_node_modules_react_index_js_default().createElement(InlineSlice,internalProps);}else if(slicesContext.renderEnvironment===`engines`){// if we're in SSR, we'll just render the component as is
return/*#__PURE__*/external_C_Users_mateu_OneDrive_Pulpit_pixel_perfect_project_node_modules_react_index_js_default().createElement(InlineSlice,internalProps);}else if(slicesContext.renderEnvironment===`slices`){// we are not yet supporting nested slices
...
const fullStack=external_C_Users_mateu_OneDrive_Pulpit_pixel_perfect_project_node_modules_react_index_js_default().__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactDebugCurrentFrame.getCurrentStack();// remove the first line of the stack trace
 ...
 * LICENSE file in the root directory of this source tree.
 */
var aa=__webpack_require__(6464),e=__webpack_require__(4377),k=null,l=0,m=!0;function p(a,b){a=a.write(b);m=m&&a}
...
"use strict";
module.exports = require("C:\\Users\\mateu\\OneDrive\\Pulpit\\pixel-perfect-project\\.cache\\ssr-builtin-trackers\\fs");
...
const React=__webpack_require__(4377);const path=__webpack_require__(1423);const{renderToString,renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(1705);const{ServerLocation,Router,isRedirect}=__webpack_require__(7896);const merge=__webpack_require__(9996);const{StaticQueryContext}=__webpack_require__(7076);const fs=__webpack_require__(6591);const{WritableAsPromise}=__webpack_require__(5897);const{RouteAnnouncerProps}=__webpack_require__(236);const{apiRunner,apiRunnerAsync}=__webpack_require__(4067);const asyncRequires=__webpack_require__(5418);const{version:gatsbyVersion}=__webpack_require__(1741);const{grabMatchParams}=__webpack_require__(9755);const{headHandlerForSSR}=__webpack_require__(923);const{SlicesResultsContext,SlicesContext,SlicesMapContext,SlicesPropsContext}=__webpack_require__(8995);const{ServerSliceRenderer}=__webpack_require__(7529);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
...
renderEnvironment:`slices`,sliceRoot:slice};const sliceElement=/*#__PURE__*/React.createElement(SlicesContext.Provider,{value:slicesContext},/*#__PURE__*/React.createElement(StaticQueryContext.Provider,{value:staticQueryContext},/*#__PURE__*/React.createElement(SliceComponent,Object.assign({sliceContext:slice.context},props))));const sliceWrappedWithWrapRootElement=apiRunner(`wrapRootElement`,{element:sliceElement},sliceElement,({result})=>{return{element:result};}).pop();const writableStream=new WritableAsPromise();const{pipe}=renderToPipeableStream(sliceWrappedWithWrapRootElement,{onAllReady(){pipe(writableStream);},onError(error){writableStream.destroy(error);}});return await writableStream;}
})();
